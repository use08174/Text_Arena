...
AI:
위의 판정 기준(criteria)와 캐릭터 설명(personas)를 반드시 참고하여 두 캐릭터 중 승자를 결정하라.  
단, 성별과 나이는 판단에 반영하지 말고, 그 외 특징들을 중심으로 평가하라.
승자는 이름만 제시하고,  
이유는 RPG 전투 묘사 스타일로 자세하고 생생하게 정확히 한 개의 완전한 문장으로 작성하라. 각 문장은 마침표(.)로 끝나야 하며, 중간에 끊기지 않도록 연결하지 말라.  
